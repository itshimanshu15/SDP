...
void main(List<String> arguments) {
  ...
  */
  ...
  const desserts = [
    ...
    'dhruv',
    'rinil'
  ]; //This is same as , final desserts = const['himanshu','dhruv','rinil'];
  // Below 3 will not work because list is const
  // desserts.add('dhiren');
  // desserts.remove('rinil');
  // desserts[0] = 'abc';
  ...
  */
  ...
  // Challenge 3:
  User user1 = User(1, 'himanshu');
  User user2 = User(2, 'dhruv');
  User user3 = User(3, 'rinil');
